...
from annotator.corpora import Collection
...
def majority_voting_entity_level(input_collections, THRESHOLD=0.5):
...
if __name__ == "__main__":
    ...
    new_collection = majority_voting_entity_level(input_collections, THRESHOLD)
