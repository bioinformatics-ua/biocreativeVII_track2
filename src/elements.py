...
class PassageOrderedList:
    ...
    def iis(self):
        ...
        for p in self.passages:
            for ii in p.indexing_identifiers():
                iis.add(ii)
        return iis
    #
    def entities(self):
...
class Document:
    ...
    #
    def entities(self):
        return self.pol.entities()
    #
    def indexing_identifiers(self):
        return self.pol.indexing_identifiers()
    #
    def json(self):
        return {
            'id': self.identifier,
...
class Collection:
    ...
    def __str__(self):
        # return f"{self.corpus}_{self.group}"
        return "{}_{}".format(self.corpus, self.group)
    
    def add_metadata(self, corpus, group):
        # Allow the collection to know the corpus were belong, change made by Tiago Almeida
        self.corpus = corpus
        self.group = group
        # need this to chain generator names 
