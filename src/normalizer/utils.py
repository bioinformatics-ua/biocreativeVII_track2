...
def dictionaryLoader(meshDictionaryTypes):
    ...
    if "MeSH_D01_04" in meshDictionaryTypes:
        with open("mesh/filteredMeSH2021_D01-D02-D03-D04.json","r") as file:
    ...
    if "MeSH_Dxx" in meshDictionaryTypes:
        with open("mesh/full_Dsection_MeSH_dictionary.json","r") as file:
            meshJSON = json.load(file)
    ...
    if "SCR" in meshDictionaryTypes:
        with open("mesh/filteredSCR2021.json","r") as file:
            meshJSON = json.load(file)
...
def mapWithAb3P(ab3P_path, corpus, meshDictionary, ab3pDictLevel, abbreviationMap=None):
...
def mapWithAb3P_AugmentedDictionary(ab3P_path, corpus, meshDictionary, ab3pDictLevel, abbreviationMap=None, test=False):
